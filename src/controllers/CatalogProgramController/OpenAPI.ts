...
registry.registerPath({
    ...
    description:
        "Retrieves a catalog program with its associated course blocks, specializations, and languages",
...
registry.registerPath({
    ...
    description:
        "Creates a new program in a catalog with optional course blocks, specializations, and languages",
...
registry.registerPath({
    ...
    description:
        "Updates a catalog program. Supports operations: remove, add, upsert, update, set (executed in order, set makes all others ignored)",
